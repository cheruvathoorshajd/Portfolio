...
// Existing JavaScript code would be here

// Add this to the initPageAnimations() function in script.js
// Skills section animation
gsap.from('.skills-wrapper', {
    scrollTrigger: {
      trigger: '.skills-container',
      start: 'top bottom', // Change this to 'top bottom'
      end: 'bottom top',
      toggleActions: 'play none none none'
    },
    opacity: 0,
    y: 50, // Add a vertical movement
    duration: 1,
    ease: 'power4.out'
  });
